...
| Tool | Purpose |
|------|---------|
| tcpdump | Command-line packet capture tool used to record raw network traffic |
| Wireshark | GUI-based traffic analyzer used to inspect captured packets in detail |
| smbclient | Linux tool used to interact with SMB file shares |
