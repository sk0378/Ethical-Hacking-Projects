...
| [Vulnerability Assessment with OpenVAS](https://github.com/sk0378/Ethical-Hacking-Projects/blob/Vulnerability_Assessment_&_Exploitation/README.md) | Deployed OpenVAS/Greenbone to run a full-depth vulnerability scan against an OWASP target, identifying critical (CVSS 10.0) findings including an end-of-life TikiWiki CMS and default Apache Tomcat credentials.|
