...
| [Password Cracking & Wordlist Generation](https://github.com/sk0378/Ethical-Hacking-Projects/blob/password_cracking_wordlist_generation/Password%20Cracking%20%26%20Wordlist%20Generation.md) | Built custom wordlists with CeWL and Crunch, merged them with John the Ripper's dictionary, then cracked SHA-512 Linux password hashes using both John the Ripper and Hashcat. |
